...
class HomeTitleView: UIView {
    ...
    fileprivate lazy var scrollView: UIScrollView = {
        let scrollView = UIScrollView(frame: CGRect(x: 0, y: 0, width: screenWidth, height: 40))
...
extension HomeTitleView {
    ...
    fileprivate func setupTitleLabels() {
        for (index, topTitle) in titles!.enumerated() {
            ...
            titleLabel.textColor = index == 0 ? UIColor.globalRedColor() : UIColor.black
